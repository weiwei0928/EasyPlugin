...
//        ThemeInflaterFactory.sConstructorMap.clear();
//        //清理Fragment的class缓存
//        FragmentClient.clearCache();
        ...
        try {
            Class tintContextWrapper = mNowClassLoader.loadClass("androidx.appcompat.widget.TintContextWrapper");
    ...
    public static void fixAppCompatActivity() {
        try {
            Class<?> appCompatDelegateImpl = Class.forName("androidx.appcompat.app.AppCompatDelegateImpl");
            Field hostField = appCompatDelegateImpl.getDeclaredField("mHost");
            hostField.setAccessible(true);
            Object hostFieldObject = hostField.get(null);

            System.out.println(hostFieldObject.getClass().getSimpleName());

            Class<?> activityThreadClass = Class.forName("android.app.ActivityThread");
//            Field sCurrentActivityField = activityThreadClass.getDeclaredField("sCurrentActivity");
//            sCurrentActivityField.setAccessible(true);
//            Object activityThread = sCurrentActivityField.get(null);
...
//
//            PackageManagerHandler packageManagerHandler = new PackageManagerHandler(iPackageManager);
